...
public class Register extends AppCompatActivity {
    ...
    CheckBox isAdminBox, isMemberBox;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isMemberBox = findViewById(R.id.isMember);

        // Logika checkbox
        isMemberBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        registerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Validasi checkbox
                if(!(isAdminBox.isChecked()|| isMemberBox.isChecked())){
                    //
